 ...
 *
 * Copia de `apps/pwa/src/estado/preferencias.ts` (ADR-0013: BLOKY toma del demo lo que le
 * sirve, sin importarlo). La clave de almacenamiento es la misma a proposito: quien escogio
 * la letra en ALICE la encuentra igual en BLOKY si usa el mismo navegador.
 *
