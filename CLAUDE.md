...
| `apps/contable/` | Aplicación contable: cartera, pagos, recibos de caja, gastos y estados financieros | HTML + CSS + JS **sin compilar** | **Jeimy** |
...
| **RN-31 a RN-33 son solo de la contable** (causación y estados financieros): viven en `apps/contable/js/contabilidad.js` y no se duplican en la PWA. | La PWA no tiene gastos ni estados financieros. |
