...
| T-10 | **Responder las preguntas de asamblea** (§3 bis) | Los tres | 🟡 A medias (2026-09-10) | Quórum, mayorías, poderes y acta **están construidos y verificados** contra la Ley 675 (RN-28, RN-74, RN-30, RN-75, RN-77), y la pantalla ya dice si un punto se aprobó, citando el artículo. El término de la comisión quedó resuelto el 2026-09-17: lo fija el administrador (RN-78). Queda **una** del reglamento —el tope de poderes— y una para el abogado —la mixta con mayoría calificada— |
