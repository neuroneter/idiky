...
| T-37 | **Sistema de gestión de IDIKY** (la administración de la empresa, no de las copropiedades): Strapi 5 + PostgreSQL 17 en `apps/gestion/` ([ADR-0012](./adr/0012-sistema-de-gestion-strapi.md)). **Instalado en el entorno el 2026-09-10**: pod en 8082, superadministrador creado y respaldo diario. Faltan abrir 8082 en Azure, el responsable, las primeras entidades y el disco de datos | Por definir | 🔨 En curso |
