...
| T-37 | **Sistema de gestión de IDIKY** (la administración de la empresa, no de las copropiedades): Strapi 5 + PostgreSQL 17 en `apps/gestion/` ([ADR-0012](./adr/0012-sistema-de-gestion-strapi.md)). **Bloqueado por**: disco de datos en Azure, subir el techo de `idiky`, responsable y primeras entidades | Por definir | 📋 Por hacer |
