...
parqueadero es bien privado o común de uso exclusivo asignado a una unidad. Daniel: «está muy bueno como lo
interpretaste». Pidió que **el agrupador sea general**: no solo zonas sociales, también torres,
manzanas y locales, porque en conjuntos muy grandes sirve para crear etapas y sectores. Hecho
en la misma versión: la **Agrupación** recibe cualquier cosa, tiene tipo (etapa, sector, bloque,
zona social, zona comercial) y tamaño ajustable, y muestra en miniatura lo que contiene. Es el
«nivel del árbol de cualquier profundidad» de docs/13 §6. Pendiente: la reacción de Daniel y
tres decisiones (dónde se asigna puesto por puesto; si al crear parqueaderos se pregunta su
naturaleza legal; si las agrupaciones se anidan) para escribir el caso de uso «Armar la
estructura».
