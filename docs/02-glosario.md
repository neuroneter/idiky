...
| **Comisión verificadora** | Quienes la asamblea designa para revisar el acta antes de publicarse. **La ley no la exige** —el art. 47 solo pide presidente y secretario— así que en Idiky es **opcional**: si no hubo revisión, el acta se aprueba directo (RN-76). | `Acta.verificadores`, `Acta.verificaciones` |
