...
| **Poder** | Documento con el que un propietario autoriza a otra persona a representar su unidad en una asamblea. **Dos puertas** (Mary, 2026-09-10): el de papel —firmado fuera de la app— que el administrador registra con el soporte adjunto, y el que **el propietario otorga desde su app**, ya autenticado. No compiten: el de papel tiene que existir siempre. | `Poder` (`origen: 'papel' \| 'app'`) |
